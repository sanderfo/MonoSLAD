...
int main(int argc, char* argv[])
{
    ...
    desc.add_options()
            ...
            ("dataFolder", boost::program_options::value<std::string>(&dataFolder)->default_value("PlaneSweepLib/data/pinholeCamera/niederdorf1"), "One of the data folders for pinhole planesweep provided with the plane sweep code.")
            ;
