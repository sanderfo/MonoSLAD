...
if __name__ == '__main__':
    ...
    dt_root = 0.1
    print("noise_acc_c" + str(noise_acc*dt_root))
    print("noise_gyr_c" + str(noise_gyr*dt_root))
    print("imu_bias_acc_rw_c" + str(imu_bias_acc_rw*10))
    print("imu_bias_gyr_rw_c" + str(imu_bias_gyr_rw*10))
